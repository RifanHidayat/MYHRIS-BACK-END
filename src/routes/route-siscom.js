...
router.get(
  ...
  placeCoordinatePengaju.PalceCoordinatePengajuan
);
...
router.post(
  ...
  auth.isAuth,
  operasional.load_approve_history
);
router.post(
...
router.post(
  "/load_notifikasi_approval",
  auth.isAuth,
  operasional.load_notifikasiApproval
);

router.post(
  "/load_laporan_absensi",
  auth.isAuth,
  operasional.load_laporan_absensi
);
router.post(
  "/load_laporan_absensi_filter_lokasi",
  auth.isAuth,
  operasional.load_laporan_absensi_filter_lokasi
);
router.post(
  "/load_laporan_absensi_tanggal",
  operasional.load_laporan_absensi_tanggal
);
router.post(
  "/load_laporan_absensi_harian",
  operasional.load_laporan_absensi_harian
);
router.post(
  "/load_laporan_absensi_harian_telat",
  operasional.load_laporan_absensi_harian_telat
);
...
router.post(
  "/load_detail_laporan_pengajuan",
  operasional.load_detail_laporan_pengajuan
);
router.post(
  "/load_laporan_pengajuan_harian",
  operasional.load_laporan_pengajuan_harian
);

router.post(
  "/insert_absen_approve_pengajuan",
  operasional.insert_absen_approve_pengajuan
);
...
router.post(
  ...
  requestAbsen.UpdateEmployeeAttendance
);
...
router.post(
  "/peraturan-perusahaan-check-employee",
  peraturanPerusahaan.checkDataByEmployee
);
//pengaduan kerusakan
...
router.post(
  ...
  auth.isAuth,
  tracking.employeeControllDetail
);
...
router.post(
  "/insert-employee_request",
  auth.isAuth,
  operasional.insert_permintaan_kandidat
);
router.post(
  "/insert_emp_control_employee",
  auth.isAuth,
  operasional.insert_emp_control_employee
);
...
router.post(
  "/history-emp_leave",
  auth.isAuth,
  operasional.historyAjuanTidakMasukKerja
);
router.post(
  "/history-permintaan_kandidat",
  auth.isAuth,
  operasional.historyPermintaanKandidat
);
router.post(
  "/emp_leave_load_izin",
  auth.isAuth,
  operasional.emp_leave_load_izin
);
router.post(
  "/emp_leave_load_izin_kategori",
  auth.isAuth,
  operasional.empIzinCategori
);
router.post(
  "/emp_leave_load_dinasluar",
  auth.isAuth,
  operasional.emp_leave_load_dinasluar
);
...
router.post(
  ...
  auth.isAuth,
  operasional.edit_last_login_id_mobile
);
router.post(
  "/edit_last_login_id_mobile",
  operasional.edit_last_login_id_mobile
);
router.post(
  "/edit_status_kandidat",
  auth.isAuth,
  operasional.edit_status_kandidat
);
router.post(
  "/edit_statusAkhir_kandidat",
  operasional.edit_statusAkhir_kandidat
);
...
router.post(
  "/surat_peringatan_status",
  suratPeringatan.updateStatusSuratPeringatan
);
