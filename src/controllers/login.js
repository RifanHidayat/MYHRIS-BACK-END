        ...
        connection.beginTransaction((err) => {
          ...
          connection.query(
            ...
            (err, results) => {
              ...
              connection.query(
                `SELECT * FROM peraturan_perusahaan WHERE  status_transaksi='1' AND tipe='utama' AND status='1'  
               ...
               ORDER BY id DESC LIMIT 1`,
                (err, dataPerusahaan) => {
                  ...
                  if (dataPerusahaan.length === 0) {
                    ...
                    connection.query(queryPeraturanLogin, (err, data) => {
                      if (err) {
                        console.error("Error executing UPDATE statement:", err);
                        connection.rollback(() => {
                          connection.end();
                          ...
                          (err) => {
                            ...
                            connection.commit((err) => {
                              ...
                              return res.status(200).send({
                                status: true,
                                message:
                                  "Kombinasi email & password Anda Salahq",
                                data: records,
                              });
                            });
                          }
