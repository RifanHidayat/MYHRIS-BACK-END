    ...
    try {
      ...
      connection.connect((err) => {
        ...
        connection.beginTransaction((err) => {
          ...
          connection.query(
            `INSERT INTO ${namaDatabaseDynamic}.emp_control (em_id, atten_date, time, longlat,address)
                    VALUES ('${emId}', '${date}', '${time}','${longlat}','${address}')`,
            (err, results) => {
              if (err) {
    ...
    try {
      ...
      connection.connect((err) => {
        ...
        connection.beginTransaction((err) => {
          ...
          connection.query(
            `SELECT * FROM emp_control where atten_date='${date}'`,
            (err, results) => {
              if (err) {
                console.error("Error executing SELECT statement:", err);
                connection.rollback(() => {
    ...
    try {
      ...
      connection.connect((err) => {
        ...
        connection.beginTransaction((err) => {
          ...
          connection.query(
            `SELECT atten_date FROM ${namaDatabaseDynamic}.emp_control WHERE em_id='${emId}' GROUP BY atten_date `,
            (err, results) => {
              if (err) {
                console.error("Error executing SELECT statement:", err);
                connection.rollback(() => {
