...
module.exports = {
  ...
  async notice(req, res) {
    ...
    .replace("?database=" + req.query.database, "").replace("&start_periode=" + req.query.start_periode, "").replace("&end_periode=" + req.query.end_periode, "");
...
console.log(req.headers)
    ...
    connection.connect((err) => {
      ...
      connection.beginTransaction((err) => {
        ...
        connection.query(`SELECT * FROM notice_question_polling_employee WHERE notice_question_id='${questionId}' AND em_id='${emId}'
        `, (err, results) => {
          if (err) {
            console.error('Error executing SELECT statement:', err);
            connection.rollback(() => {
  ...
  async overtime(req, res) {
    ...
    connection.connect((err) => {
      ...
      connection.beginTransaction((err) => {
        ...
        connection.query(`SELECT * FROM ${database}_hrm.overtime  WHERE aktif='Y'` ,(err, results) => {
          if (err) {
            console.error('Error executing SELECT statement:', err);
            connection.rollback(() => {
              connection.end();
...
.replace("?database=" + req.query.database, "").replace("&start_periode=" + req.query.start_periode, "").replace("&end_periode=" + req.query.end_periode, "")
  ...
  async whereTwo(req, res) {
    ...
    let name_url = req.originalUrl;
    var convert1 = name_url.substring(name_url.lastIndexOf("/") + 1)
    .replace("?database=" + req.query.database, "").replace("&start_periode=" + req.query.start_periode, "").replace("&end_periode=" + req.query.start_periode, "");
    var convert2 = convert1.substring(convert1.lastIndexOf("-") + 1);
  ...
  historyData(req, res) {
    ...
    console.log('-----hoistory data dengan start periode and periode----------')
    var database = req.query.database;
    let name_url = req.originalUrl;
    var convert1 = name_url.substring(name_url.lastIndexOf("/") + 1)
.replace("?database=" + req.query.database, "").replace("&start_periode=" + req.query.start_periode, "").replace("&end_periode=" + req.query.end_periode, "")
...
console.log('em_id 1',req.query)
 ...
 .replace("?database=" + req.query.database, "").replace("&start_periode=" + req.query.start_periode, "").replace("&end_periode=" + req.query.end_periode, "")
    ...
    var leaveTypes=req.body.leave_type==undefined?"":req.body.leave_type;
          ...
          if (err) {
            ...
            return;
              ...
              [dataInsertLog], (err, results) => {
                ...
                connection.query(getDataTransaksi,
                   (err,transaksi ) => {
                  if (err) {
                    console.error('Error executing SELECT statement:', err);
                    connection.rollback(() => {
                  ...
                  connection.query( `SELECT IFNULL(name,'') as name FROM ${database}_hrm.sysdata WHERE KODE IN ('022','023','013','044')`, (err, sysdata) => {
                    if (err) {
                      console.error('Error executing SELECT statement:', err);
                      connection.rollback(() => {
                        connection.end();
                  ...
                  if  (  (menu_name=="Lembur" && sysdata[0].name=="1" && bodyStatusFinal=="Approve" ) || (menu_name=="Lembur" && sysdata[0].name=="2" && (bodyStatusFinal=="Approve2"))  ){
                    ...
                    for (var i=0;i<tasks.length;i++){
                       ...
                       connection.query( `UPDATE ${namaDatabaseDynamic}.emp_labor_task SET persentase='${tasks[i]['persentase']}' WHERE id='${tasks[i]['id']}' `, (err, employeeApproved) => {
                    if (err) {
                      console.error('Error executing SELECT statement:', err);
                      connection.rollback(() => {
                        connection.end();
                    ...
                    if (tasks.length>0){
                      ...
                      if (parseFloat(totalPersentase.toString())< parseFloat(sysdata[3].name.toString())){
...
console.log(bodyValue)
                  ...
                  connection.query(script,
                    ...
                    connection.query( `SELECT * FROM ${database}_hrm.leave_types WHERE id='${typeId}'`, (err, leaveTypes) => {
                      if (err) {
                        console.error('Error executing SELECT statement:', err);
                        connection.rollback(() => {
                          connection.end();
                    ...
                    */
                    ...
                    if (leaveTypes.length>0){
                      if (leaveTypes[0].status=="2" || leaveTypes[0].status==2 ){
                        namaTransaksi='Sakit'
                        urlTransaksi='sakit';
  
                       }
                       if (leaveTypes[0].status=="1" || leaveTypes[0].status==1  ){
                        namaTransaksi='Cuti'
                        urlTransaksi='Cuti';
                       ...
                       if (leaveTypes[0].status=="3" || leaveTypes[0].status==3  ){
                        namaTransaksi='Izin'
                        urlTransaksi='Izin';
                       }
...
.replace("?database=" + req.query.database, "").replace("&start_periode=" + req.query.start_periode, "").replace("&end_periode=" + req.query.end_periode, "")
    ...
    try{ 
      ...
      const connection=await model.createConnection(database);
            connection.connect((err) => {
                ...
                connection.beginTransaction((err) => {
                  ...
                  connection.query( `UPDATE ${nameTable} SET ? WHERE ${nameWhere} = '${cariWhere}'`, [dataInsertLog], (err, empLabor) => {
                    if (err) {
                      console.error('Error executing SELECT statement:', err);
                      connection.rollback(() => {
                        connection.end();
              ...
              connection.query(  `INSERT INTO ${namaDatabaseDynamic}.logs_actvity SET ?;`, [dataInsertLog], (err, results) => {
                if (err) {
                  console.error('Error executing SELECT statement:', err);
                  connection.rollback(() => {
                    connection.end();
      ...
      connection.query( `SELECT * FROM ${namaDatabaseDynamic}.emp_labor WHERE nomor_ajuan='${nomorAjuan}'`, [dataInsertLog], (err, empLabor) => {
                  if (err) {
                    console.error('Error executing SELECT statement:', err);
                    connection.rollback(() => {
                      connection.end();
                  ...
                  connection.query( `INSERT attendance`, [dataInsertLog], (err, results) => {
                    if (err) {
                      console.error('Error executing SELECT statement:', err);
                      connection.rollback(() => {
                        connection.end();
              ...
              if (err) {
                ...
                return;
                  ...
                  connection.query( query, (err, results) => {
                    ...
                    connection.query( `SELECT * FROM employee_history WHERE em_id='${em_id}' ORDER BY id DESC`, (err, history) => {
                      if (err) {
                        console.error('Error executing SELECT statement:', err);
                        connection.rollback(() => {
                          connection.end();
                  ...
                  connection.query( `SELECT * FROM  department WHERE  id='${results[0].dep_id}'`, (err, depertment) => {
                    if (err) {
                      console.error('Error executing SELECT statement:', err);
                      connection.rollback(() => {
                        connection.end();
                    ...
                    if (results[0].tipe_absen=='' || results[0].tipe_absen=='0' || results[0].tipe_absen==null || results[0].tipe_absen==undefined ){
...
//   },
    ...
    var script = `INSERT INTO ${namaDatabaseDynamic}.emp_leave SET ?`;
      ...
      connection.connect((err) => {
        ...
        connection.beginTransaction((err) => {
          ...
          //get sysdata
          connection.query(`SELECT * FROM ${namaDatabaseDynamic}.emp_leave WHERE ajuan='4'`, (err, results) => {
            if (err) {
              console.error('Error executing SELECT statement:', err);
              connection.rollback(() => {
                connection.end();
            ...
            connection.query(script,[insertData], (err, results) => {
              ...
              connection.query(`SELECT * FROM ${namaDatabaseDynamic}.emp_leave WHERE nomor_ajuan='${ insertData.nomor_ajuan  }'`,
              (err, transaksi) => {
             if (err) {
               console.error('Error executing SELECT statement:', err);
               connection.rollback(() => {
             ...
             connection.query(`SELECT * FROM ${databaseMaster}.employee WHERE em_id='${insertData.em_id}'`,
              (err, employee) => {
                 if (err) {
                   console.error('Error executing SELECT statement:', err);
                   connection.rollback(() => {
         ...
         utility.insertNotifikasi(employee[0].em_report_to,'Approval Dinas Luar','DinasLuar',employee[0].em_id,transaksi[0].id,transaksi[0].nomor_ajuan,employee[0].full_name,namaDatabaseDynamic,databaseMaster)
  ...
  async kirimAbsenNew(req,res){
    ...
    var endTime=req.body.end_time==undefined?"":endTime=req.body.end_time;
    ...
    try{
        ...
        connection.connect((err) => {
          ...
          connection.beginTransaction((err) => {
            ...
            connection.query(`SELECT IFNULL(branch.zona_waktu,0) AS zona_waktu FROM employee LEFT JOIN branch ON employee.branch_id=branch.id  WHERE employee.em_id='${req.body.em_id}'`, (err, employee) => {
              if (err) {
              ...
              console.log("zona waktu" ,parseInt(employee[0].zona_waktu.toString()))
              ...
              var insertData = {
                ...
                signout_time: jamKeluar == "null" || jamKeluar == null || jamKeluar == "" || jamKeluar == undefined ? "00:00:00" : jamKeluar,
                working_hour: "",
            ...
            connection.query(queryCek, (err, data) => {
                ...
                if (req.body.kategori == "1") {
                  if (data.length == 0) {
                    ...
                    connection.query(`INSERT INTO ${namaDatabaseDynamic}.attendance SET ?;`, [insertData],(err, results) => {
                      if (err) {
                        console.error('Error executing SELECT statement:', err);
                        connection.rollback(() => {
                          connection.end();
                    ...
                    if (lastItem.signout_longlat == "") {
                      ...
                      connection.query( `UPDATE ${namaDatabaseDynamic}.attendance SET signout_time='${jamKeluar}', place_out='${lokasiAbsenOut}', signout_longlat='${latLangOut}', signout_pict='${gambarKeluar}', signout_note='${catatanKeluar}', signout_addr='${lokasiKeluar}' WHERE id='${id_record}' ;`,(err, results) => {
                        if (err) {
                          console.error('Error executing SELECT statement:', err);
                          connection.rollback(() => {
                            connection.end();
   ...
   var queryEmployee=`SELECT IFNULL(branch.zona_waktu,0) AS zona_waktu FROM employee LEFT JOIN branch ON employee.branch_id=branch.id  WHERE employee.em_id='${req.body.em_id}' ORDER BY id DESC `
    ...
    try {
      ...
      if (results.length>1){
        ...
        await connection.query(`INSERT INTO ${namaDatabaseDynamic}.attendance SET ?`, [insertData]);
        ...
        console.log('masuk sini 12')
            var id_record = lastItem.id;
            const [dataKeluar] = await connection.query(    `UPDATE  ${namaDatabaseDynamic}.attendance SET signout_time='${jamKeluar}', place_out='${lokasiAbsenOut}', signout_longlat='${latLangOut}', signout_pict='${gambarKeluar}', signout_note='${catatanKeluar}', signout_addr='${lokasiKeluar}' WHERE id='${id_record}' `);       
            


            const [cekLembur] = await connection.query(` SELECT nomor_ajuan FROM ${namaDatabaseDynamic}.emp_labor WHERE nomor_ajuan LIKE '%LB%' AND tgl_ajuan='${dateNow}'`);

            console.log(`SELECT nomor_ajuan FROM ${namaDatabaseDynamic}.emp_labor WHERE nomor_ajuan LIKE '%LB%' AND tgl_ajuan='${dateNow}'`)
  ...
  //logic Lembur
  console.log("tes  tes")
  const [sysdataLembur] = await connection.query( `SELECT * FROM ${namaDatabasMaster}.sysdata WHERE kode IN ('041','042') `);     
  ...
  if (sysdataLembur[0].name=='1' || sysdataLembur[0].name==1  ){ 
    ...
    if (jamlembur=="" || jamlembur=="00:00"){
      ...
      if (jamAbsen>jamParameter){
        ...
        const [showDataLembur] = await connection.query(` SELECT nomor_ajuan FROM ${namaDatabaseDynamic}.emp_labor WHERE nomor_ajuan LIKE '%LB%' ORDER BY id DESC LIMIT 1`);
        const [employee] = await connection.query(`SELECT * FROM employee WHERE em_id='${req.body.em_id}'`);
       ...
       // var emReportTo=employee[0].em_report2_to.split(',')
        ...
        const selisihMenit = Math.floor(selisihMilidetik / (1000 * 60)); // 1000 ms * 60 detik = 1 menit

        const [lokasi] = await connection.query(` SELECT * FROM overtime WHERE lokasi  LIKE '%${lokasiAbsenOut}%' `);
        ...
        if (lokasi.length>0){
          ...
          const [insertLembur] = await connection.query(`INSERT INTO  ${namaDatabaseDynamic}.emp_labor SET ?;`, [dataLembur]);
                ...
                const [insert] = await connection.query(`INSERT INTO  ${namaDatabaseDynamic}.attendance SET ?;`, [insertData]);
        ...
        await connection.query(`INSERT INTO ${namaDatabaseDynamic}.attendance SET ?`, [insertData]);
        console.log("proses insert ",`INSERT INTO ${namaDatabaseDynamic}.attendance SET ?`)
        console.log(insertData)
          ...
          if (statusAbsen=='terlambat'){ 
            ...
            const [sysdata] = await connection.query(` SELECT name FROM ${namaDatabasMaster}.sysdata WHERE kode IN ('S01','020','029','S08','SO9') `);
            ...
            console.log(sysdata)
              ...
              const tanggalSekarangsp1= tanggalSekarang.setMonth(tanggalSekarang.getMonth() + parseInt(splitBulan[0].toString()));
              const tanggalSekarangsp2= tanggalSekarang.setMonth(tanggalSekarang.getMonth() + parseInt(splitBulan[1].toString()));
            ...
            SELECT RankedAttendance1.* 
              ...
              deskription=`Anda sudah terlambat ${terlambat.length}x. Mohon perhatikan waktu kedatangan di lain kesempatan 
              jika terlambat mencapai ${parseInt(sysdata[1].name)}x. Kami akan mengeluarkan surat peringatan`
              utility.insertNotifikasiAbsensi(sysdata[2].name,'Absensi Terlambat',statusAbsen,employee[0].emId,'','',employee[0].full_name,namaDatabaseDynamic,namaDatabasMaster)
              ...
              if (terlambat.length>=parseInt(sysdata[1].name))
              {
                ...
                const [cekDataSp] = await connection.query(`SELECT * FROM employee_letter
                ...
                const [dataSp] = await connection.query(`SELECT * FROM ${namaDatabasMaster}.employee_letter WHERE nomor LIKE '%SP%' AND nomor IS NOT NULL  ORDER BY id DESC LIMIT 1`);
                ...
                const [data] = await connection.query(`INSERT INTO employee_letter (nomor,tgl_surat,em_id,letter_id,eff_date,upload_file,status,approve_status,title,exp_date)
                 VALUES ('${nomorSp}','${utility.dateNow2()}','${em_id}','${idSp}','${utility.dateNow2()}','','${status}','${approveStatus}','${titleAbsen}','${fixtgl2}') `);

                 const [insertDetail] = await connection.query(`INSERT INTO employee_letter_reason (employee_letter_id,name) VALUES('${data.insertId}','${alasan}')`);
               

                const [sysdataSP] = await connection.query(` SELECT name FROM ${namaDatabasMaster}.sysdata WHERE kode IN ('026','027')`);
                if (sysdataSP.length>0){
  
                  if (sysdataSP[0].name!=null){
                    
                    utility.insertNotifikasiAbsensiSp(sysdataSP[0].name,'Absensi Terlambat',statusAbsen,employee[0].emId,'',sysdataSP[0].nomor,employee[0].full_name,
                    namaDatabaseDynamic,namaDatabasMaster,statusSpName)
           
                  }
                  if (sysdataSP[1].name!=null){
                    
                    utility.insertNotifikasiAbsensiSp(sysdataSP[1].name,'Absensi Terlambat',statusAbsen,employee[0].emId,'',sysdataSP[0].nomor,employee[0].full_name,
                    namaDatabaseDynamic,namaDatabasMaster,statusSpName)
                ...
                if (sysdataSP.length>0){
                  ...
                  if (sysdataSP[0].name!=null){
                    ...
                    utility.insertNotifikasiAbsensiSp(sysdataSP[0].name,'Absensi Terlambat',statusAbsen,employee[0].emId,'','',employee[0].full_name,namaDatabaseDynamic,namaDatabasMaster,statusSpName)
           
                  }
                  if (sysdataSP[1].name!=null){
                    
                    utility.insertNotifikasiAbsensiSp(sysdataSP[1].name,'Absensi Terlambat',statusAbsen,employee[0].emId,'','',employee[0].full_name,namaDatabaseDynamic,namaDatabasMaster,statusSpName)
                ...
                const [data] = await connection.query(`INSERT INTO employee_letter (nomor,tgl_surat,em_id,letter_id,eff_date,upload_file,status,approve_status,title)
          ...
          if (lastItem.signout_longlat == "" || lastItem.signout_time == "00:00:00")  {
            var id_record = lastItem.id;
            const [dataKeluar] = await connection.query(    `UPDATE  ${namaDatabaseDynamic}.attendance SET signout_time='${jamKeluar}', place_out='${lokasiAbsenOut}', signout_longlat='${latLangOut}', signout_pict='${gambarKeluar}', signout_note='${catatanKeluar}', signout_addr='${lokasiKeluar}' WHERE id='${id_record}' `);
            const [jamMasuk] = await connection.query(`SELECT  IFNULL(work_schedule.time_out ,'17:00:00') as jam_masuk FROM ${namaDatabaseDynamic}.emp_shift  JOIN ${database}_hrm.work_schedule ON emp_shift.work_id=work_schedule.id WHERE emp_shift.em_id='${em_id}' AND emp_shift.atten_date LIKE '%${dateNow}%'`);
     ...
     if (statusAbsen=='pulang_cepat') {
           ...
           const [sysdata] = await connection.query(`SELECT IFNULL(name,3) as name FROM sysdata WHERE kode IN ('S02','030','020','S10','S11')`);
      ...
      //     ;
        ...
        // AND attendance.em_id=emp_shift.em_id JOIN work_schedule ON work_schedule.id=emp_shift.work_id  WHERE attendance.em_id='${em_id}' AND work_schedule.time_out > attendance.signout_time  AND attendance.signout_time!='00:00:00' `);
           ...
           utility.insertNotifikasiAbsensi(sysdata[2].name,'Absensi Pulang Cepat',statusAbsen,employee[0].emId,'','',employee[0].full_name,namaDatabaseDynamic,namaDatabasMaster)
          ...
          if ((pulangCepat.length>=parseInt(sysdata[3].name))){
            ...
            if (pulangCepat.length>=sysdata[1].name){
              ...
              const [cekDataSp] = await connection.query(`SELECT * FROM employee_letter WHERE em_id='${req.body.em_id}' AND status IN ('Pending','Appprove','Approved') AND alasan LIKE '%${alasan}%'`);
              ...
              if (cekDataSp.length>0){
                  ...
                  if (sysdataSP.length>0){
                    ...
                    if (sysdataSP[0].name!=null){
                      ...
                      utility.insertNotifikasiAbsensiSp(sysdataSP[0].name,'Absensi Pulang Cepat',statusAbsen,employee[0].emId,'','',employee[0].full_name,namaDatabaseDynamic,namaDatabasMaster,statusSpName)
             
                    }
                    if (sysdataSP[1].name!=null){
                      
                      utility.insertNotifikasiAbsensiSp(sysdataSP[1].name,'Absensi Pulang Cepat',statusAbsen,employee[0].emId,'','',employee[0].full_name,namaDatabaseDynamic,namaDatabasMaster,statusSpName)
                ...
                const [dataSp] = await connection.query(`SELECT * FROM employee_letter WHERE nomor LIKE '%SP%'  ORDER BY id DESC LIMIT 1`);   
     ...
     try{
      ...
      connection.connect((err) => {
        ...
        connection.beginTransaction((err) => {
          ...
          connection.query(`SELECT * FROM employee WHERE em_id='${req.body.em_id}'`, (err,employee) => {
            if (err) {
            ...
            if (err) {
              ...
              return;
               ...
               if (results.length == 0) {
                ...
                connection.query(`SELECT  IFNULL(work_schedule.time_in ,'08:30:00') as jam_masuk FROM ${namaDatabaseDynamic}.emp_shift  JOIN ${database}_hrm.work_schedule ON emp_shift.work_id=work_schedule.id WHERE emp_shift.em_id='${em_id}' AND emp_shift.atten_date LIKE '%${dateNow}%'`, (err,jamMasuk) => {
                  if (err) {
                    console.error('Error executing UPDATE statement:', err);
                    connection.rollback(() => {
             ...
             if (statusAbsen=='terlambat'){
              ...
              console.log("masuk sini  sini sono ",`SELECT  name FROM ${namaDatabasMaster}.sysdata WHERE kode IN ('S01','028','020') `)
              
               connection.query( `SELECT name FROM ${namaDatabasMaster}.sysdata WHERE kode IN ('S01','028','020') `, (err,sysdata) => {
                 if (err) {
                   console.error('Error executing UPDATE statement terlambat new:', err);
                   connection.rollback(() => {
                 ...
                 console.log(`SELECT attendance.* FROM ${namaDatabaseDynamic}.attendance LEFT  JOIN ${namaDatabaseDynamic}.emp_shift ON emp_shift.atten_date=attendance.atten_date JOIN ${namaDatabasMaster}.work_schedule  ON work_schedule.id=emp_shift.work_id  WHERE attendance.em_id='${em_id}' AND work_schedule.time_in < attendance.signin_time`)

                 utility.insertNotifikasiAbsensi(sysdata[2].name,'Absensi Terlambat',statusAbsen,"",employee[0].full_name,namaDatabaseDynamic,namaDatabasMaster)
               ...
               const tanggalSekarangsp1= tanggalSekarang.setMonth(tanggalSekarang.getMonth() + parseInt(splitBulan[0].toString()));
                 ...
                 connection.query( `SELECT attendance.* FROM ${namaDatabaseDynamic}.attendance LEFT  JOIN ${namaDatabaseDynamic}.emp_shift ON emp_shift.atten_date=attendance.atten_date JOIN ${namaDatabasMaster}.work_schedule  ON work_schedule.id=emp_shift.work_id  WHERE attendance.em_id='${em_id}' AND work_schedule.time_in < attendance.signin_time `, (err,Terlambat) => {
                   if (err) {
                     console.error('Error executing UPDATE statement:', err);
                     connection.rollback(() => {
                  ...
                  if (Terlambat.length>parseInt(sysdata[1].name))
                 {
                   connection.query(`SELECT * FROM ${namaDatabasMaster}.employee_letter WHERE nomor LIKE '%SP1%'  ORDER BY id DESC LIMIT 1`, (err,dataSp) => {
                     if (err) {
                       console.error('Error executing UPDATE statement:', err);
                       connection.rollback(() => {
                   ...
                   connection.query(`INSERT INTO employee_letter SET `,[dataInsert], (err,sysdataSp) => {
                     if (err) {
                       console.error('Error executing UPDATE statement:', err);
                       connection.rollback(() => {
                     ...
                     connection.query(`SELECT * FROM ${namaDatabasMaster}.sysdata WHERE kode ('026','027') `, (err,sysdataSp) => {
                       if (err) {
                         console.error('Error executing UPDATE statement:', err);
                         connection.rollback(() => {
                ...
                if (lastItem.signout_longlat == "") {
                  var id_record = lastItem.id;
                  connection.query(`UPDATE  ${namaDatabaseDynamic}.attendance SET signout_time='${jamKeluar}', place_out='${lokasiAbsenOut}', signout_longlat='${latLangOut}', signout_pict='${gambarKeluar}', signout_note='${catatanKeluar}', signout_addr='${lokasiKeluar}' WHERE id='${id_record}' `, [insertData], (err,resultss) => {
                    if (err) {
                      console.error('Error executing UPDATE statement:', err);
                      connection.rollback(() => {
                    ...
                    connection.query(`SELECT  IFNULL(work_schedule.time_out ,'17:00:00') as jam_masuk FROM ${namaDatabaseDynamic}.emp_shift  JOIN ${database}_hrm.work_schedule ON emp_shift.work_id=work_schedule.id WHERE emp_shift.em_id='${em_id}' AND emp_shift.atten_date LIKE '%${dateNow}%'`, (err,jamMasuk) => {
                      if (err) {
                        console.error('Error executing UPDATE statement:', err);
                        connection.rollback(() => {
           ...
           if (statusAbsen=='pulang-cepat') {
               ...
               connection.query( `SELECT IFNULL(name,3) as name FROM sysdata WHERE kode IN ('S01','030','020')`, (err,sysdata) => {
                 if (err) {
                   console.error('Error executing UPDATE statement:', err);
                   connection.rollback(() => {
                 ...
                 utility.insertNotifikasi(sysdata[2].name,'Absensi Pulang Cepat',statusAbsen,"",employee[0].full_name,namaDatabaseDynamic,namaDatabasMaster)
                 connection.query( ` SELECT * FROM ${namaDatabaseDynamic}.attendance JOIN ${namaDatabaseDynamic}.emp_shift ON emp_shift.atten_date=attendance.atten_date JOIN work_schedule ON work_schedule.id=emp_shift.work_id  WHERE attendance.em_id='${em_id}' AND work_schedule.time_out > attendance.signout_time `, (err,pulangCepat) => {
                   if (err) {
                     console.error('Error executing UPDATE statement:', err);
                     connection.rollback(() => {
                  ...
                  if (pulangCepat.length>sysdata[1].name){
                       connection.query(`SELECT * FROM employee_letter WHERE nomor LIKE '%SP1%'  ORDER BY id DESC LIMIT 1`, (err,dataSp) => {
                         if (err) {
                           console.error('Error executing UPDATE statement:', err);
                           connection.rollback(() => {
      ...
      console.log("absen istirahat ")
       ...
       jamKeluar=formattedTime;
           ...
           var insertData = {
             ...
             breakin_time: jamMasuk == null || jamMasuk == "" || jamMasuk == undefined ? "00:00:00" : jamMasuk,
             breakout_time: jamKeluar == "null" || jamKeluar == null || jamKeluar == "" || jamKeluar == undefined ? "00:00:00" : jamKeluar,
             working_hour: "",
  ...
  load_approve_info(req, res) {
    ...
    poolDynamic.getConnection(function (err, connection) {
      if (err) {
        ...
        connection.query(
          `${query1};${query2};${query3};${query4};${query5};${query6};${query7};${query8};${query9};${query10};`,[em_id],
          function (error, results) {
            if (error != null) console.log(error)
            connection.release();
            res.send({
...
var endTime=req.body.endTime==undefined?"":endTime=req.body.endTime;
var queryCek=''
        ...
        try{
            ...
            connection.connect((err) => {
              ...
              connection.beginTransaction((err) => {
                ...
                connection.query( `SELECT emp_labor.nomor_ajuan,employee.* FROM ${namaDatabaseDynamic}.emp_labor JOIN ${database}_hrm.employee ON employee.em_id=emp_labor.em_id WHERE emp_labor.id='${id}'`, (err,dataAbsensi) => {
                ...
                connection.query( `SELECT * FROM sysdata WHERE KODE IN ('022','023','013')`, (err, sysdata) => {
                  ...
                  VALUES ('${emId}','${date??""}','${dataAbsensi[0].signin_out}??""}','${dataAbsensi[0].signout_time??""}','${dataAbsensi[0].place_in??""}','${dataAbsensi[0].place_out??""}','${dataAbsensi[0].signin_longlat}','${dataAbsensi[0].signout_longlat}','${dataAbsensi[0].signin_pict??""}','${dataAbsensi[0].signout_pict??""}','${dataAbsensi[0].signin_note??""}','${dataAbsensi[0].signout_out??""}','','',1,1,"","","","","") `
                    ...
                    if (results.length == 0) {
                      ...
                      if (lastItem.signout_longlat == "") {
                        var id_record = lastItem.id;
                        connection.query(`UPDATE attendance SET signout_time='${dataAbsensi[0].sampai_jam}', place_out='${dataAbsensi[0].place_out}', signout_longlat='${dataAbsensi.signout_longlat}', signout_pict='${dataAbsensi[0].signout_pict}', signout_note='${dataAbsensi.sign_note}', signout_addr='${dataAbsensi[0].signout_addr}' WHERE id='${id_record}' `, (err,results) => {
                          if (err) {
                            console.error('Error executing UPDATE statement:', err);
                            connection.rollback(() => {
                ...
                connection.query( `SELECT * FROM sysdata WHERE KODE IN ('022','023','013')`, (err, sysdata) => {
                    ...
                    connection.query( query1, (err, results) => {
                      ...
                      for (var i=0;i<listData.length;i++){
                          ...
                          connection.query(
                            ...
                            console.log(`INSERT INTO ${namaDatabaseDynamic }.notifikasi (em_id,title,deskripsi,url,atten_date,jam,status,view) VALUES ('${employee[0].em_id}','${title}','${deskripsi}','${urlTransaksi}',CURDATE(),CURTIME(),0 ,0)`)
                          connection.query(
                            `INSERT INTO ${namaDatabaseDynamic }.notifikasi (em_id,title,deskripsi,url,atten_date,jam,status,view) VALUES ('${employee[0].em_id}','${title}','${deskripsi}','${urlTransaksi}',CURDATE(),CURTIME(),0 ,0)`,
                           (err, results) => {
                            if (err) {
                 ...
                 connection.query(`${queryCek}`, (err,results) => {
                  if (err) {
                    ...
                    atttype,
                    reg_type,working_hour,absence,overtime,earnleave,status)
                  VALUES ('${emId}','${date??""}','${dataAbsensi[0].dari_jam}','${dataAbsensi[0].sampai_jam }','${dataAbsensi[0].place_in??""}','${dataAbsensi[0].place_out??""}','${dataAbsensi[0].signin_longlat}','${dataAbsensi[0].signout_longlat}','${dataAbsensi[0].signin_pict??""}','${dataAbsensi[0].signout_pict??""}','${dataAbsensi[0].signin_note??""}','${dataAbsensi[0].signout_out??""}','','',1,1,"","","","","") `
...
a.typeid,
 a.date_selected,
   ...
   spesifik_approval_multi(req, res) {
    ...
    var getbulan = req.body.bulan;
    var gettahun = req.body.tahun;
    var stauts=req.body.status==undefined?"Pending":req.body.status=="pending"?"Pending":req.body.status;
    var conditionStatus="";
...
a.time_plan_to,
    ...
    AND a.branch_id=${branchId} AND (b.em_report_to LIKE '%${em_id}%' OR b.em_report2_to LIKE '%${em_id}%')  ${conditionStatus}  AND a.leave_status!='Cancel' AND a.ajuan IN ('2', '3')  AND a.status_transaksi=1 ${orderby1}`;
...
c.input_time,
     ...
     b.em_report2_to as em_report2_to,   b.full_name, c.name as nama_tipe, c.category FROM ${namaDatabaseDynamic}.emp_leave a 
     INNER JOIN ${database}_hrm.leave_types c ON a.typeid=c.id JOIN ${database}_hrm.employee b  JOIN ${database}_hrm.designation  d ON d.id=b.des_id 
     WHERE a.em_id=b.em_id AND a.branch_id=${branchId} AND (b.em_report_to LIKE '%${em_id}%' OR b.em_report2_to LIKE '%${em_id}%') 
...
o.dinilai,
     ...
     o.name as nama_pengajuan, b.em_report_to as em_report_to,  b.em_report2_to as em_report2_to,   b.full_name FROM ${namaDatabaseDynamic}.emp_labor a JOIN ${database}_hrm.employee b LEFT JOIN ${database}_hrm.overtime o ON o.id=a.typeId  WHERE a.em_id=b.em_id AND a.branch_id=${branchId} 
    ...
    a.approve_date,
    a.id,
      b.em_report_to as em_report_to,  b.em_report2_to as em_report2_to,   b.full_name FROM ${namaDatabaseDynamic}.emp_labor a JOIN ${database}_hrm.employee b WHERE a.em_id=b.em_id AND a.branch_id=${branchId} AND (b.em_report_to LIKE '%${em_id}%' OR b.em_report2_to LIKE '%${em_id}%') ${conditionStatusLabor} AND a.status!='Cancel' AND a.ajuan='2'  AND a.status_transaksi=1 
      ${orderby1} 
      `;
    ...
    a.typeid,
     ...
     a.branch_id=${branchId} AND (b.em_report_to LIKE '%${em_id}%' OR b.em_report2_to LIKE '%${em_id}%')  ${conditionStatus}  
     ...
     a.approve2_by, (IFNULL(a.sisa_claim ,0)) as sisa_claim ,(IFNULL(a.saldo_claim ,0)) as saldo_claim , c.id as id_ajuan, b.em_report_to as em_report_to,  b.em_report2_to as em_report2_to,   b.full_name, c.name as nama_tipe, a.*
      FROM ${namaDatabaseDynamic}.emp_claim a INNER JOIN ${database}_hrm.cost c ON a.cost_id=c.id JOIN ${database}_hrm.employee b
      WHERE a.em_id=b.em_id AND a.branch_id=${branchId} AND (b.em_report_to LIKE '%${em_id}%' OR b.em_report2_to LIKE '%${em_id}%')  AND a.status!='Cancel' ${conditionStatusLabor} ${orderby1}`
     ...
     var query7 = `SELECT b.em_report_to as em_report_to,  b.em_report2_to as em_report2_to,  
      ...
      WHERE a.em_id=b.em_id  AND a.branch_id=${branchId} AND (b.em_report_to LIKE '%${em_id}%' OR b.em_report2_to LIKE '%${em_id}%') AND ${conditionStatusLabor} AND a.status!='Cancel' AND a.ajuan='3' AND a.status_transaksi=1
      a.id ORDER BY DESC
      `;
...
a.place_out as place_out,
     ...
     JOIN ${database}_hrm.employee b   WHERE a.em_id=b.em_id AND a.branch_id=${branchId} AND (b.em_report_to LIKE '%${em_id}%' OR b.em_report2_to LIKE '%${em_id}%') ${conditionStatusLabor} AND( a.ajuan='3' OR a.ajuan='5') AND a.status_transaksi=1
     ${orderby1}
     `;
 ...
 "Surat Peringatan 1"as nama,
      ...
      JOIN ${database}_hrm.employee b WHERE a.em_id=b.em_id AND a.branch_id=${branchId} AND (b.em_report_to LIKE '%${em_id}%' OR b.em_report2_to LIKE '%${em_id}%') ${conditionStatusLabor} AND a.ajuan='4' AND a.status_transaksi=1 ${orderby1}` ;
      ...
      emp_loan.periode_mulai_cicil as periode,
      emp_loan.nomor_ajuan,emp_loan.description,emp_loan.total_loan as total_pinjaman ,emp_loan.durasi_cicil 
      FROM ${database}_hrm.sysdata JOIN ${database}_hrm.emp_loan ON sysdata.kode='019' JOIN ${database}_hrm.employee ON employee.em_id=emp_loan.em_id WHERE sysdata.name LIKE '%${em_id}%' AND emp_loan.status  LIKE '%${stauts}%'   AND a.branch_id=${branchId} AND emp_loan.em_id!='${em_id}' ORDER BY id DESC`;
      ...
      a.id,
       ...
       WHERE a.em_id=b.em_id  AND a.branch_id=${branchId} AND a.status LIKE '%${stauts}%' AND a.status!='Cancel' AND sysdata.name LIKE '%${em_id}%'`;
...
a.typeid,
 ...
 slipGaji(req, res) {
  ...
  load_laporan_absensi(req, res) {
    console.log('-----load laporan absensi periode----------',req.headers.em_id)
    ...
    if (montStart<monthEnd || date1.getFullYear()<date2.getFullYear()){
      ...
      `;
       ...
       query2 = `SELECT A.full_name, A.job_title, C.id as id_absen, C.em_id, C.atten_date, C.signin_time, C.signout_time, C.signin_longlat, C.signout_longlat, C.signin_note, C.place_in FROM ${startPeriodeDynamic}.attendance C RIGHT JOIN ${database}_hrm.employee A ON A.em_id=C.em_id WHERE A.branch_id=${branchId} AND  CONCAT(C.atten_date,C.signin_time)=(SELECT MAX(CONCAT(atten_date,signin_time)) FROM ${startPeriodeDynamic
      }.attendance WHERE em_id=C.em_id) AND A.dep_id='${status}' AND A.status='ACTIVE' AND (A.em_report_to LIKE '%${emId}%' OR A.em_report2_to LIKE '%${emId}%') 
        AND C.atten_date >='${startPeriode}' AND C.atten_date<='${endPeriode}' 
        GROUP BY A.full_name, A.job_title, C.em_id, C.atten_date, C.signin_time, C.signout_time, C.place_in, C.signin_note
        ...
        connection.beginTransaction((err) => {
          if (err) {
            ...
            return;
              ...
              connection.query(`SELECT * FROM ${namaDatabaseDynamic}.emp_labor WHERE ajuan='3' AND em_id='${em_id}' AND atten_date='${req.body}' AND (status='Approve' OR status='Pending')`, (err, results) => {
                if (err) {
                  console.error('Error executing SELECT statement:', err);
                  connection.rollback(() => {
                    connection.end();
                ...
                connection.query(`SELECT * FROM ${databaseMaster}.places_coordinate WHERE id='${lokasiMasuk}' `, (err,lokasiMasukResult) => {
                  if (err) {
                    console.error('Error executing SELECT statement:', err);
                    connection.rollback(() => {
                      connection.end();
                  ...
                  connection.query(`SELECT * FROM ${databaseMaster}.places_coordinate WHERE id='${lokasiKeluar}' `, (err, lokasiKeluarResult) => {
                    if (err) {
                      console.error('Error executing SELECT statement:', err);
                      connection.rollback(() => {
                        connection.end();
            ...
            connection.query(` SELECT nomor_ajuan FROM ${namaDatabaseDynamic}.emp_labor WHERE ajuan='3' ORDER BY id DESC `,
               (err, results) => {
              if (err) {
                console.error('Error executing SELECT statement:', err);
                connection.rollback(() => {
              ...
              , (err, results) => {
                  ...
                  connection.query(`SELECT * FROM ${namaDatabaseDynamic}.${namaTable} WHERE nomor_ajuan='${nomorAjuan}'`,
                       (err, transaksi) => {
                      if (err) {
                        console.error('Error executing SELECT statement:', err);
                        connection.rollback(() => {
